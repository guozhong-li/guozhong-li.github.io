...
<div class="homepage-page">
  <section class="homepage-hero" aria-labelledby="homepage-name">
    <img class="homepage-avatar" src="/images/csgzli.png" alt="Guozhong Li">
    <div>
  ...
  <section class="homepage-section" aria-labelledby="homepage-news-title">
    <div class="homepage-section__heading">
      <h2 id="homepage-news-title">🔥 News</h2>
    </div>
  ...
  <section class="homepage-section" aria-labelledby="homepage-research-title">
    <div class="homepage-section__heading">
  ...
  <section class="homepage-section" aria-labelledby="homepage-honors-title">
    ...
    <div>
      ...
      <details class="homepage-earlier-honors">
        <summary><span>Earlier honors</span><span aria-hidden="true"></span></summary>
        <ul>
          <li><span>Outstanding Graduate Student · UESTC</span><time>2014, 2017</time></li>
          <li><span>IBM-CSC Scholarship</span><time>2015</time></li>
